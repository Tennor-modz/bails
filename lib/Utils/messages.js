...
const generateWAMessageContent = async (message, options) => {
  ...
  if ('text' in message) {
    ...
    m.groupInviteMessage.groupDescription = message.groupInvite.description;
    m.groupInviteMessage.jpegThumbnail = message.groupInvite.jpegThumbnail;
    m.groupInviteMessage.inviterJid = message.groupInvite.inviterJid;
    m.groupInviteMessage.type = WAProto_1.proto.GroupInviteMessage.Type.INVITE;
    if (message.groupInvite.type === 'community') {
      m.groupInviteMessage.type = WAProto_1.proto.GroupInviteMessage.Type.COMMUNITY_INVITE;
      m.groupInviteMessage.communityJid = message.groupInvite.communityJid;
      m.groupInviteMessage.communityName = message.groupInvite.communityName;
      m.groupInviteMessage.communityDescription = message.groupInvite.communityDescription;
      m.groupInviteMessage.communityThumbnail = message.groupInvite.communityThumbnail;
}
